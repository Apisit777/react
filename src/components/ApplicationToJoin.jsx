...
export class ApplicationToJoinCompo extends React.PureComponent {
    constructor(props) {
        super(props);
            ...
            <div>
                <form className="mt-6 flex justify-center items-center flex-col gap-4">
                    <div className="relative page text-black flex justify-center items-center">
                        <p className="absolute text-md top-1 font-semibold">Test Page3</p>
...
ApplicationToJoinCompo.propTypes = {
    dataDataLoanDebts: PropTypes.object,
};

// export default ApplicationToJoin
export const ApplicationToJoin = React.forwardRef((props, ref) => {
    return <ApplicationToJoinCompo ref={ref} dataDataLoanDebts={props.dataDataLoanDebts} />;
});
